...
- 🛠️ TypeScript, React, Vite, ESLint flat config, and smart semver bump scripts
...
- 🤝 [Contributing](CONTRIBUTING.md) covers local setup, quality checks, and pull request expectations.
- 🛟 [Support](SUPPORT.md) explains where to ask for help, report bugs, and suggest ideas.
- 🔐 [Security](SECURITY.md) explains how to report vulnerabilities and what is in scope.
- 🌈 [Code of Conduct](CODE_OF_CONDUCT.md) sets the baseline for respectful project participation.
- 🔒 [Privacy](PRIVACY.md) describes browser-local audio handling, permissions, and app caching.
- 🎉 [What's New](WHATSNEW.md) tracks recent release highlights.
- 🐛 [Bug reports](.github/ISSUE_TEMPLATE/bug_report.yml), ✨ [feature requests](.github/ISSUE_TEMPLATE/feature_request.yml), and 🎚️ [pull requests](.github/PULL_REQUEST_TEMPLATE.md) use the GitHub templates in this repo.
